...
const content = {
  ua: {
    ...
    why: [
      ...
      'Бруківці понад сто років — а твій час на ній лишиться в протоколі назавжди.',
      'П’ять тисяч років історії під колесами: старовинний узвіз, ландшафтний парк «Смородинський» і Змієва печера.',
      'Найкоротша гонка сезону з найдовшим післясмаком — кілька хвилин на трасі, цілий рік історій.',
      'Дізнайся, скільки ватів у тобі насправді — підйом не бреше.',
      'Вузька бруківка між схилами, дві спроби і фінал на виліт — такої гонки в столиці та околицях більше немає.',
      'Доторкнутись до духу Туру Фландрії — легендарної бруківкової класики, що надихнула «Гори Вище».',
      'Ціла велоспільнота в одному місці — знайомство з однодумцями, з якими потім не раз перетнешся на старті.',
      'Не просто гонка, а міні-свято на Татарці: глядачі, музика й культурна програма про історію Києва.',
    ],
  ...
  en: {
    ...
    why: [
      ...
      'Find out how many watts are really in you — the cobbles don’t lie.',
      'The cobblestone is over a century old — but your time on it stays in the protocol forever.',
      'Five thousand years of history under your wheels: an ancient climb, the Smorodynskyi landscape park, and the Serpent’s Cave.',
      'The shortest race of the season with the longest afterglow — a few minutes on the course, a whole year of stories.',
      'A narrow cobbled ramp between the slopes, two attempts, and a knockout final — there’s nothing else like it in the capital.',
      'A taste of the Tour of Flanders — the legendary cobbled classic that inspired «Hory Vyshche».',
      'A whole cycling community in one place — meet like-minded riders you’ll keep running into at the start line.',
      'Not just a race, but a little festival on Tatarka: spectators right above the cobbles, music, and a cultural program on the history of Kyiv.',
    ],
